...
settings-youtube = Канал YouTube
...
settings-permissions = Полномочия
...
settings-get-token = Получение токена доступа
...
settings-invalidate-tokens = Отключить токены
