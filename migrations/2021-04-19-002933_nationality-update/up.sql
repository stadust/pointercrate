...
CREATE TYPE continent AS ENUM ('Asia', 'Europe', 'Australia and Oceania', 'Africa', 'North America', 'South America', 'Middle America');

ALTER TABLE nationalities ADD COLUMN continent continent;

INSERT INTO nationalities (iso_country_code, nation, continent)
VALUES
    ('BQ', 'Bonaire', 'Middle America'),
    ('JM', 'Jamaica', 'Middle America'), 
    ('PR', 'Puerto Rico', 'Middle America'), 
    ('DO', 'Dominican Republic', 'Middle America'), 
    ('HT', 'Haiti', 'Middle America'), 
    ('SV', 'El Salvador', 'Middle America'), 
    ('GT', 'Guatemala', 'Middle America'), 
    ('HN', 'Honduras', 'Middle America'), 
    ('NI', 'Nicaragua', 'Middle America'), 
    ('PA', 'Panama', 'Middle America'), 
    ('CR', 'Costa Rica', 'Middle America'), 
    ('MX', 'Mexico', 'Middle America'), 
    ('MS', 'Montserrat', 'Middle America'), 
    ('VG', 'British Virgin Islands', 'Middle America'), 
    ('VI', 'US Virgin Islands', 'Middle America'), 
    ('KN', 'Saint Kitts and Nevis', 'Middle America'), 
    ('KY', 'Cayman Islands', 'Middle America'), 
    ('AI', 'Anguilla', 'Middle America'), 
    ('GD', 'Grenada', 'Middle America'), 
    ('LC', 'Saint Lucia', 'Middle America'), 
    ('VC', 'Saint Vincent and the Grenadines', 'Middle America'), 
    ('TC', 'Turks and Caicos Islands', 'Middle America'), 
    ('BB', 'Barbados', 'Middle America'), 
    ('AG', 'Antigua and Barbuda', 'Middle America'), 
    ('SX', 'Sint Maarten (Dutch Part)', 'Middle America'), 
    ('DM', 'Dominica', 'Middle America'), 
    ('TT', 'Trinidad and Tobago', 'Middle America'), 
    ('BS', 'Bahamas', 'Middle America'), 
    ('BZ', 'Belize', 'Middle America'), 
