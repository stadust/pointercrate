SELECT player_claims.id, members.member_id AS mid, members.name AS mname, players.id AS pid, players.name as pname, verified
FROM player_claims
    INNER JOIN members on member_id=user_id
