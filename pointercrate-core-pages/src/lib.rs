    ...
    pub fn new(site_name: impl Into<String>, nav_bar: NavigationBar, footer: Footer) -> Self {
        ...
        PageConfiguration {
            ...
            head: Head::new(default_head_html)
                ...
                .script("https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js?v=3")
                .script("https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js?v=3")
                .script("/static/core/js/ui.js?v=3")
                .script("/static/core/js/nav.js?v=3")
                .script("/static/core/js/misc.js?v=3")
